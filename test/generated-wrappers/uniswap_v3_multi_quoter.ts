...
public static async deployFrom0xArtifactAsync(
        ...
        return UniswapV3MultiQuoterContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, );
    }
    ...
    public static async deployAsync(
        ...
        const contractInstance = new UniswapV3MultiQuoterContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
> {
    ...
    constructor(
        ...
        super('UniswapV3MultiQuoter', UniswapV3MultiQuoterContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
